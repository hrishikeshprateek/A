...
public class ProfilePersonAdapter extends RecyclerView.Adapter<ProfilePersonAdapter.ViewHolder>{

    Context context;
    List<String> lists;

    public ProfilePersonAdapter(Context context, List<String> lists) {
